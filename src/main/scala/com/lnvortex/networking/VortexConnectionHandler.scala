  ...
  def connected(unalignedBytes: ByteVector): Receive = LoggingReceive {
    ...
    case Tcp.Received(data) =>
      ...
      val (messages, newUnalignedBytes) =
        VortexConnectionHandler.parseIndividualMessages(bytes)
    ...
    case c @ Tcp.CommandFailed(_: Tcp.Write) =>
      ...
      handler ! VortexConnectionHandler.WriteFailed(c.cause)
    case VortexConnectionHandler.CloseConnection =>
...
object VortexConnectionHandler extends Logging {
